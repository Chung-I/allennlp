...
@TokenEmbedder.register("pretrained_transformer_mismatched_configurable")
class PretrainedTransformerMismatchedEmbedderConfigurable(TokenEmbedder):
    """
    ...
    def __init__(
        self,
        model_name: str,
        matched_embedder_name: str = None,
        max_length: int = None,
        ...
        matched_embedder_kwargs: Optional[Dict[str, Any]] = None,
    ) -> None:
        super().__init__()
        # The matched version v.s. mismatched
        if matched_embedder_name is not None:
            MatchedEmbedderClass = TokenEmbedder.by_name(matched_embedder_name)
            self._matched_embedder = MatchedEmbedderClass(
                model_name,

...
@TokenEmbedder.register("pretrained_transformer_zeromean")
class PretrainedTransformerEmbedderZeroMean(TokenEmbedder):
    """
    ...
    def __init__(
        ...
        *,
        ...
        self.transformer_model = ZMBertModel.from_pretrained(model_name)
        ...
        if single_layer:
            self.language_mean = language_mean
        else:
            self.language_mean = language_mean[language_layer]
    ...
    def forward(
        ...
        if self.language_layer is not None and self.language_mean is not None:
            parameters["language_hidden_states"] = self.language_mean.to(get_device_of(token_ids))
